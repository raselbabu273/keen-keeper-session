...
const Hero = () => {
  ...
  return (
    <div className="pt-10 max-w-14/16 md:pt-20 md:max-w-12/16 mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 justify-center gap-6 border-b border-gray-300 my-5 md:my-12">
        <div className="text-center bg-[#FFFFFF] p-8 shadow-md rounded-md w-full">
